...
<div class="container fill" id="main">
    ...
    <div class="row col-12" id="mainRow">
        ...
        <div id="contentHeader" >
            <div class="page-header clearfix">
                <h1 class="pull-left">
                    <small<?php
                    if ($isLogged) {
                        echo " id='helloMessage'><a href='index.php'> Questions</a> / " . getCurrentCategory($_GET['cid']);
                    } else {
                ...
                if ($isLogged) {
                    ?>
                    <a href="create_topic.php<?php echo '?cid='. $_GET['cid'] ?>" class="btn btn-large btn-default pull-right" id="btn-newQ">
        ...
        <div class="well well-large container topicsViewer">
            <?php
            $cid = $_GET['cid'];
            ...
            if(mysql_num_rows($res) == 1) {
                ...
                for($i = 1; $i <= $totalPages; $i++) {
                    echo "<a href =\"view_category.php?cid={$cid}&page={$i}\"><div class='well wells-small pageNums pull-left'>{$i}</div></a> ";
                }
            } else {
