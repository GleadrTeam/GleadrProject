...
<div class="container fill" id="main">
    ...
    <div class="row col-12" id="mainRow">
        ...
        <div id="contentHeader" >
            <div class="page-header clearfix">
                <h1 class="pull-left">
                    <small<?php
                    if ($isLogged) {
                        echo " id='helloMessage'>POST REPLY";
                    } else {
        ...
        <div class="container well well-large">
            <div id="content">
                <form action="post_reply_parse.php" method="post" role="form">
                    <div class="form-group">
                        <label for="reply" class="control-label">Post Reply:</label>
                        <textarea name="reply_content" id="reply" cols="75" rows="5" class="form-control"></textarea>
                    </div>

                    <input type="hidden" name="cid" value="<?php echo $cid?>"/>
                    <input type="hidden" name="tid" value="<?php echo $tid ?>"/>
                    <input type="submit" name="reply_submit" class="btn btn-default pull-right" value="Post Your Reply"/>
                </form>
            </div>
        </div>
