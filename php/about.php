...
<div class="container fill" id="main">
    ...
    <div class="row col-12" id="mainRow">
        ...
        <div class="well well-lg col-lg-3 pull-left"><h4>Atanas</h4></div>
        <div class="well well-lg col-lg-3 pull-left"><h4>Valleri</h4> </div>
        <div class="well well-lg col-lg-3 pull-left"><h4>Pepi</h4> </div>
        <div class="well well-lg col-lg-3 pull-left"><h5>Deyan</h5></div>
