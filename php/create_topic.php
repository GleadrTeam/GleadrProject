    ...
    <div class="row col-12" id="mainRow">
        ...
        <div id="contentHeader" >
            <div class="page-header clearfix">
                <h1 class="pull-left"><small>NEW QUESTION</small>
        ...
        // getting categories and let User choose if he is not in category:
        $getCategories ="SELECT * FROM categories ORDER BY category_title DESC";
        $getCResult = mysql_query($getCategories) or die(mysql_error());
        $categoriesList = [];
        while ($cRow = mysql_fetch_assoc($getCResult)) {
            $categoriesList[$cRow['id']] = $cRow['category_title'];
        }
        ?>

        <div class="well well-large container">

                <form action="create_topic_parse.php" role="form" method="post" class="form-horizontal newTopic">
                    <div class="form-group pull">
                        <label for="categoryChoice" class="control-label"> CATEGORY: </label>
                        <div class="">
                            <select name="cid" id="categoryChoice" class="form-control ">
                                <?php
                    ...
                    <div class="form-group">
                        <label for="topicContent" class="control-label">TOPIC CONTENT</label>
                        <textarea name="topic_content" cols="75" id="topicContent" class="form-control" rows="5"></textarea>
                    </div>
                    <input type="submit" name="topic_submit" class="btn btn-default pull-right" value="POST YOUR QUESTION"/>
