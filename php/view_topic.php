        ...
        <div id="contentHeader" >
            <div class="page-header clearfix">
                <h1 class="pull-left">
                    <small<?php
                    if ($isLogged) {
                        echo " id='helloMessage'><a href='index.php'>Questions</a> / <a href='view_category.php?cid=". $_GET['cid'] ."'>" . getCurrentCategory($_GET['cid']) .'</a>';
                    } else {
            ...
            <div id="content">
                ...
                if(isset($_GET['cid']) && isset($_GET['tid'])) {
                    ...
                    for($i = 1; $i <= $allPosts; $i++) {
                        echo " <a href =\"view_topic.php?cid={$cid}&tid={$tid}&page={$i}\"><div class='well wells-small pageNums pull-left'>{$i}</div></a> ";
                    }
                }
                else {
